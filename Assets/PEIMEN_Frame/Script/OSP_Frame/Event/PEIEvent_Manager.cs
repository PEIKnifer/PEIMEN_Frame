...
{
    public class PEIEvent_Manager : PEIModel_Origin
    {
        #region 属性
        //监听函数
        private readonly Dictionary<int, EventHandler<PEIEvent_Origin>> _allActions = new Dictionary<int, EventHandler<PEIEvent_Origin>>();
        #endregion
