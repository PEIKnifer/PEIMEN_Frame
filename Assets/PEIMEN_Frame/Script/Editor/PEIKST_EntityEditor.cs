...
{
    [CustomEditor(typeof(PEIKST_Entity))]
    public class PEIKST_EntityEditor : Editor
    {
        private PEIKST_Entity _entity;
        ...
        //所有的模块
        private List<PEIModule_STEditorOrigin> _listModuleEditors;
